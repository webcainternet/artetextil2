...
--
-- Host: localhost:3306
-- Generation Time: May 17, 2015 at 02:07 AM
...
(4393, 0, 'config', 'config_encryption', '5513448cc0fcefe2d6a0a8b337c7d0ce', 0),
...
(4394, 0, 'config', 'config_api_id', '9', 0),
...
(4391, 0, 'config', 'config_email', 'contato@lojavirtual.digital', 0),
...
(4392, 0, 'config', 'config_url', 'http://artetextil2.homolog.lojavirtual.digital/', 0);
...
(1, 1, 'admin', 'de9452af89dd1333925da8a52c243cb91c4c6148', '45d9be938', 'John', 'Doe', 'contato@lojavirtual.digital', '', '', '', 1, '2015-05-17 05:00:41');
...
--
ALTER TABLE `oc_setting`
MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4395;
--
